...
class CDCGAN(GANBase):
    ...
    def build_generator(self):
        ...
        model.add(
            tf.keras.layers.Conv2DTranspose(self.channels, kernel_size=3, strides=2, padding='same', activation='tanh'))
        # (None, 28, 28, 1)
        model.summary()
...
if __name__ == '__main__':
    ...
    gan.train(x_train, y_train, epochs=30001, batch_size=32, save_interval=200,
              sample_path="samples/conditional_dcgan_mnist")
    gan.save("models/conditional_dcgan_mnist")
